		...
		<div class="cardheader">
			<div class="row">
				...
				<form class="form-inline my-2 my-lg-0" action="" type="get">
					<div>
					<a href="{{ route('order.getOrdersHistoryListPageForQC') }}" style="width:20%" class="btn btn-success btn-sm float-end" id="requestbutton">Order History</a>
						<div class="row g-3 align-items-center">
							
							<div class="col-auto">
								<form action="{{route('qc.designsListPage')}}" method="GET">
			...
			@if(count($data) > 0)
				...
				@foreach($data as $row)
					...
					<tr>
						...
						<td><a style="text-decoration:none; color:white" class="viewbutton" href="{{ route('order.showForQCP', $row->id) }}" class="btn btn-primary btn-sm">View order</a></td>
					</tr>
