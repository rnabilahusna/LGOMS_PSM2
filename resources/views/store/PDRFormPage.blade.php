    ...
    <div class="card">
        ...
        <div class="cardheader">
                <div class="row">
                    ...
                    <a href="{{route('order.showForStoreP',$pdr->getOrder->id)}}" class="btn btn-primary btn-sm float-end" id="requestbutton" style="width:15%">Back</a>
                </div>
                </div>
            </div>
    ...
    <hr>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input  name="stock" class="form-control"  type="number" value="{{ $pdr->stock }}" ></td>
                    <td><input  name="deliveryQuantity" class="form-control"  type="number" value="{{ $pdr->deliveryQuantity }}" ></td>
                    <td><input  name="balance" class="form-control"  type="number" value="{{ $pdr->balance }}" ></td>
