...
<div class="menu-container">
    ...
    <div class="cardheader">
			<div class="row">
                ...
                <a href="{{ route('store.ordersListPage') }}" style="width:90px" class="btn btn-success btn-sm float-end" id="requestbutton">
				...
				@foreach($data as $key=>$row)
					...
					<tr>
						...
						<td>
							...
							<a style="text-decoration:none;color:white" href="{{ route('order.showForStoreP',$row->id) }}" >View</a>
							</button>
                        </td>
					</tr>
